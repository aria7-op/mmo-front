...
const Gallery4ColumnContent = () => {
    ...
    return (
        <>
            <div className="gallery-sec gallery4-column pt-120 pb-120">
                        ...
                        <Gallery>
                            ...
                            <div className="row" ref={galleryRef}>
                                {GalleryV1Data.map((gallery) => (
                                    <div className={`col-lg-3 col-sm-6 gallery-items ${gallery.category}`} key={gallery.id}>
...
export default Gallery4ColumnContent;