...
const SingleShopContent = ({ shop }) => {
    const { thumb, oldPrice, newPrice, name } = shop;

    return (
        <>
            <div className="product-inner">
                <div className="product-thumb">
                    <Link to="/product-details#"><img src={`img/product/${thumb}`} alt="product" /></Link>
                </div>
                <div className="product-text">
                    <span className="product-price">${newPrice}</span>
                    <span className="regular-price"><strike>{oldPrice}</strike></span>
