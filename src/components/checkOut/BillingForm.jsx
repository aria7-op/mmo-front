...
const BillingForm = () => {
    ...
    const handleSubmit = (event) => {
        ...
        console.log('Sanitized billing data:', formData);
    ...
    return (
        <>
            <div className="billing-form billing-details">
                    ...
                    <div className="one-column-single">
                        <div className="row">
                            <div className="col-md-6 two-column-input">
                                <input type="text" placeholder="City" name='city' value={formData.city} onChange={handleChange} autoComplete='off' />
                            </div>
                            <div className="col-md-6 two-column-input">
