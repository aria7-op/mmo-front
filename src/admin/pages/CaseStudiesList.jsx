/**
 * Case Studies List Page - Rewritten with modern styling and React error prevention
...
const CaseStudiesList = () => {
    ...
    const { caseStudies, pagination, loading, error, refetch } = useCaseStudies(filter);
    ...
    const handleEdit = async (id) => {
        try {
            ...
            const studyData = await getCaseStudyById(id, token);
            ...
            setFormData({
                ...
                challenge: data.challenge || { en: '', per: '', ps: '' },
                solution: data.solution || { en: '', per: '', ps: '' },
                results: data.results || { en: '', per: '', ps: '' },
            ...
            console.error('Failed to load case study for edit', e);
            showErrorToast('Failed to load case study for editing');
        }
    };

    const handleDelete = async (id) => {
        if (!window.confirm(t('admin.deleteCaseStudyConfirm', 'Are you sure you want to delete this case study?'))) {
            return;
        }
    ...
    return (
        <AdminLayout>
            <div className="admin-case-studies-list" style={{ direction: isRTL ? 'rtl' : 'ltr', padding: '16px' }}>
                {/* Header */}
                <div style={{ 
                    display: 'flex', 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <div>
                            ...
                            <p style={{ margin: '2px 0 0 0', fontSize: '12px', color: '#6c757d' }}>
                                Manage case studies and research reports
                            </p>
                        </div>
                    </div>
                    <div style={{ display: 'flex', gap: '8px' }}>
                        ...
                        <button
                            ...
                            title="Refresh case studies list"
                        >
                ...
                <div style={{ 
                    ...
                    <div style={{ 
                        ...
                        {[
                            { id: 'list', label: 'Case Studies List', icon: 'list' },
                                    ...
                                    {paginatedStudies?.map((item) => (
                                        <div key={item._id} style={{ 
                                            ...
                                            <div>
                                                <ImageCell 
                                                    imageUrl={item.image} 
                                                    alt={safeFormatContent(item.title, 'Case study image')} 
                                                />
                                            </div>
                                            <div>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <h2 style={{ marginBottom: '20px', color: '#212529' }}>
                                {editingStudy ? 'Edit Case Study' : 'Create Case Study'}
                            </h2>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                                    ...
                                    >
                                        {submitting ? 'Saving...' : (editingStudy ? 'Update' : 'Create')}
                                    </button>
                                </div>
                            </form>
                        </div>
